        ...
        <div className='min-h-screen bg-gray-100 p-6 pt-8'>
            <div className='flex justify-between items-center mb-4'>
                ...
                <Dialog open={open} onOpenChange={handleDialogClose}>
                    ...
                    <DialogContent className="max-w-screen max-h-screen sm:max-w-2xl">
                        <DialogHeader>
                        ...
                        <div className="grid gap-4 py-4">
                            ...
                            {
                                return (
                                    <div key={title} className='grid grid-cols-1 items-center gap-4 sm:grid-cols-3 sm:gap-0'>
                            ...
                            <Table>
                                <TableHeader>
                                    <TableRow className="text-left">
                                        ...
                                        <TableHead className="px-3 py-3 text-xs font-medium text-gray-700 uppercase tracking-wider">Quantity</TableHead>
                                ...
                                <TableBody>
                                    <TableRow>
                                        ...
                                        <TableCell><Input className="min-w-20" id="rate" type='number' value={rate} disabled></Input></TableCell>
                                        <TableCell><Input id="quantity" type='number' min='1' max={maxQuantity} value={quantity} onChange={e =>
                                        {
                                            ...
                                            if (!isNaN(newQuantity) && newQuantity <= maxQuantity)
                                            {
                ...
                <div className='p-4 bg-white'>
                    <div className='overflow-x-auto'>
                        ...
                        <Dialog open={saleDialog} onOpenChange={setSaleDialog}>
                            {
                                selectedSale && (
                                    <DialogContent className="max-w-screen max-h-screen overflow-y-auto md:max-h-none md:overflow-y-visible sm:max-w-3xl">
                                        <div ref={printRef}>
                                            <DialogHeader>
                                                <DialogTitle>
                                                    {selectedSale.id}
                                            ...
                                            <div className="grid gap-6 py-4">
                                                ...
                                                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                                    <div className="p-4 border rounded-md">
                                                        ...
                                                        <p>{new Date(selectedSale.saleDate).toLocaleDateString('en-GB')}</p>
                                                    </div>
                                                    <div className="p-4 border rounded-md">
                                                        <h3 className="font-semibold text-sm text-gray-500 mb-1">Total Amount</h3>
                                                        <p className="font-semibold text-lg">₹ {selectedSale.totalAmount}</p>
                                                    </div>
                                                </div>


                                                <div className="border rounded-md p-4">
                                                    <h3 className="font-semibold text-md mb-3">Customer Information</h3>
                                                    {(() =>
                                                    {
                                                        const customerObj = customers.find(c => c._id === selectedSale.customer);
                                                        return customerObj ? (
                                                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                                                <div>
                                                ...
                                                <div className="border rounded-md p-4">
                                                    <h3 className="font-semibold text-md mb-3">Vendor Information</h3>
                                                    {(() =>
                                                    {
                                                        const vendorObj = vendors.find(v => v._id === selectedSale.vendorId);
                                                        return vendorObj ? (
                                                ...
                                                <div className="border rounded-md p-4">
                                                    <h3 className="font-semibold text-md mb-3">Sale Items</h3>
                                                    <div className='w-full overflow-x-auto'>
                                                        <Table className="min-w-full">
                                                            <TableHeader>
                                                                <TableRow className="text-left">
                                                                    <TableHead className="py-2 text-xs font-medium text-gray-700 uppercase tracking-wider">Item Name</TableHead>
                                                                    <TableHead className="py-2 text-xs font-medium text-gray-700 uppercase tracking-wider">Price</TableHead>
                                                                    <TableHead className="py-2 text-xs font-medium text-gray-700 uppercase tracking-wider">Quantity</TableHead>
                                                                    <TableHead className="py-2 text-xs font-medium text-gray-700 uppercase tracking-wider">Amount</TableHead>
                                                                </TableRow>
                                                            </TableHeader>
                                                            <TableBody>
                                                                {selectedSale.saleItems?.map((item, index) => (
                                                                    <TableRow key={index} className="text-left">
                                                                        ...
                                                                        <TableCell className="py-2">₹ {item.rate}</TableCell>
                                                            ...
                                                            <TableBody>
                                                                <TableRow className="text-left bg-gray-50">
                                                                    <TableCell colSpan={3} className="px-4 py-2 text-right font-semibold">Total:</TableCell>
                                                                    <TableCell className="px-4 py-2 font-semibold">₹ {selectedSale.totalAmount}</TableCell>
                                                                </TableRow>
                                                            </TableBody>
                                                        </Table>
                                                    </div>
